        ...
        describe('when required is nonempty, one is empty', () => {
            ...
            describe('return true when', () => {
                it('one true in req', () => {
                    ...
                    const func = Filter.multipleFilters({ every: [returnTrue] });
                ...
                it(' two true filters in req', () => {
                    ...
                    const func = Filter.multipleFilters({ every: [returnTrue, returnTrue] });
                    expect(func()).resolves.toBe(true);
            ...
            describe('return false when', () => {
                ...
                it('one false in req', () => {
                    ...
                    const func = Filter.multipleFilters({ every: [returnFalse] });
                ...
                it('two false in req', () => {
                    ...
                    const func = Filter.multipleFilters({ every: [returnFalse, returnFalse] });
                    expect(func()).resolves.toBe(false);

                });
                it('one false, one true in req ', () => {

                    const func = Filter.multipleFilters({ every: [returnFalse, returnTrue] });
                    expect(func()).resolves.toBe(false);
        ...
        describe('when required is empty, one is nonempty', () => {
            describe('return true when', () => {
                ...
                it('two true', () => {
                    ...
                    const func = Filter.multipleFilters({ some: [returnTrue, returnTrue] });
                    expect(func()).resolves.toBe(true);
                ...
                it('one false, one true', () => {
                    ...
                    const func = Filter.multipleFilters({ some: [returnFalse, returnTrue] });
                    expect(func()).resolves.toBe(true);
            ...
            describe('return false when', () => {
                ...
                it('one false in req', () => {
                    ...
                    const func = Filter.multipleFilters({ some: [returnFalse] });
                    expect(func()).resolves.toBe(false);
                ...
                it('two false in req', () => {
                    ...
                    const func = Filter.multipleFilters({ some: [returnFalse, returnFalse] });
                    expect(func()).resolves.toBe(false);
        ...
        describe('when both are nonempty', () => {
            ...
            describe('when true', () => {
                ...
                it('is true when req is true and one has a true', () => {
                    const func = Filter.multipleFilters({ every: [returnTrue], some: [returnTrue] });
                    expect(func()).resolves.toBe(true);
                });

                it('is true when req is true and one has a false', () => {
                    const func = Filter.multipleFilters({ every: [returnTrue], some: [returnTrue, returnFalse] });
                    expect(func()).resolves.toBe(true);
                });

                it('is true when req has two true and one true', () => {
                    const func = Filter.multipleFilters({ every: [returnTrue, returnTrue], some: [returnTrue] });
                    expect(func()).resolves.toBe(true);
                });
                it('is true when req has two true and two true', () => {
                    const func = Filter.multipleFilters({ every: [returnTrue, returnTrue], some: [returnTrue, returnTrue] });
                    expect(func()).resolves.toBe(true);
                });
            ...
            describe('when false', () => {
                it('req is false and one has true', () => {
                    ...
                    const func = Filter.multipleFilters({ every: [returnFalse], some: [returnTrue] });
                    expect(func()).resolves.toBe(false);
                });

                it('req is false and one is false', () => {

                    const func = Filter.multipleFilters({ every: [returnFalse], some: [returnFalse] });
                    expect(func()).resolves.toBe(false);
                });
                ...
                it('req is true and one is false', () => {
                    ...
                    const func = Filter.multipleFilters({ every: [returnTrue], some: [returnFalse] });
                    expect(func()).resolves.toBe(false);
                });
            });
            ...
            it.each([
                ...
                (regexString, input, off, on) => {
                    falseTrue.forEach(enabled => {
                        const expected = !enabled ? off : on;
                        const message = Mocks.mockMessage(input, '12345', 'text');
                        const res = Filter.stringFilter(regexString, { insensitive: enabled, loose: true })(message);
                        expect(expected).toBe(res);
                    })
                }
            );
            ...
            it.each([
                ...
                (regexString, input, off, on) => {
                    falseTrue.forEach(enabled => {
                        const expected = !enabled ? off : on;
                        const message = Mocks.mockMessage(input, '12345', 'text');
                        const res = Filter.stringFilter(regexString, { trimRegex: enabled, loose: true })(message);
                        expect(expected).toBe(res);
                    })
                }
            );
            ...
            it.only.each([
                ...
                (regexString, input, off, on) => {
                    falseTrue.forEach(enabled => {
                        const expected = !enabled ? off : on;
                        const message = Mocks.mockMessage(input, '12345', 'text');
                        const res = Filter.stringFilter(regexString, { trimInput: enabled, loose: true })(message);
                        expect(expected).toBe(res);
                    })
                }
            );
            ...
            */
            ...
            it.each(
                ...
                async (messageContent: string[], desiredMessageIndex: number, filter: AnyCollectorFilter) => {
                    const messages = messageContent.map(x =>
                        Mocks.mockMessage(x, userID, 'text')
                    )
